                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-12 ">
                                    <h2 class="text-center" style="width: 18rem;">Shop By Care:</h2>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-12 ">
                                    <h2 class="text-center" style="width: 18rem;">Shop By Size:</h2>
                                    <div class="card text-center" style="width: 18rem;">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="row">
                                <div class="col-12 ">
                                    <h2 class="text-center" style="width: 18rem;">Shop By Light:</h2>
                                    <div class="card text-center" style="width: 18rem;">
